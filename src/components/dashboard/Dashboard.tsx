...
export function Dashboard({ data }: DashboardProps) {
  return (
    <div className="space-y-8">
      {/* Welcome section */}
      <div className="bg-gradient-to-r from-cco-primary-600 to-cco-primary-800 rounded-xl p-6 sm:p-8 text-white shadow-lg">
        <div className="max-w-3xl">
          <h1 className="text-2xl sm:text-3xl font-bold mb-3">Welcome back, Alex!</h1>
          <p className="text-cco-primary-100 mb-4">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <Button 
              variant="accent" 
              size="lg" 
              className="bg-white text-cco-primary-800 hover:bg-cco-neutral-100"
            >
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="bg-transparent border-white text-white hover:bg-cco-primary-700"
            >
